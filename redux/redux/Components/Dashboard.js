...
import {
    Text, View, Image, ActivityIndicator, FlatList, Modal,
...
const Dashboard = props => {
    ...
    const getResults = async () => {
        ...
        if (artist != '') {
            ...
            SetIsLoding(false);
            setMessage('Hello broo, Please select some artist name or band to search');
            setIsVisible(true);
            ...
            <Modal
                ...
                <View style={{ backgroundColor: Colors.gray_text, flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{
                        ...
                        <Image source={require('../assets/images/bg.png')} style={{ width: 100, height:150, resizeMode: 'contain' }} />
                        <Text style={Styles.title}>Message from App</Text>
                        <Text style={Styles.msg}>{message}</Text>

                        <TouchableOpacity onPress={() => { setIsVisible(!isVisible) }} style={{backgroundColor:Colors.happy_green, alignItems:'center', width:'100%', paddingVertical:20, borderRadius:10, marginTop:12}}>
                            <Text style={{color:Colors.white, fontFamily:'Poppins-SemiBold', fontSize:17}}>GOT IT!</Text>
                        </TouchableOpacity>
                            ...
                            {itunesData?.allTracks?.results?.length > 0 ?
                                ...
                                (
                                    <View style={{ width: '100%', alignItems: 'center' }}>
                                        <Image source={require('../assets/images/bg.png')} style={{ width: 300, resizeMode: 'contain' }} />
